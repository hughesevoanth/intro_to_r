...
- You can generate
    ...
    -   pdf
    -   word docs
    -   html slides (presentations) - such as this one.
    -   handouts
    -   books
    -   dashboards
    -   articles
...
:::{.column width=50%}
![](../images/Markdown1.png){width=100%}
:::

:::{.column width=50%}

![](../images/Markdown2.png){width=100%}
...
## To start a new RMarkdown file cont'd 1
...
1. Start a new Rmarkdown file
2. Title it: **"My First RMarkdown File"**
3. We want to render to HTML
4. Describe what you will be doing in this "report". Think about the good coding practices we previously discussed. 
5. In your first code chunk ( [Cmd+Option+I] on a Mac) *head()* the iris data set.
6. In your second code chunk: use the *apply()* function to estimate the *mean()* of the numeric columns.
7. Make a scatter **plot**, illustrating the relationship between *Sepal.Width* and *Petal.Length*. Color each observation by *Species*
8. Save your file
9. Render your document by clicking on "Knit".

## What should our exercise look like?

My Rmarkdown file, for this exercise, is below and [here]().

![](../images/MyFirstRMarkdown.png){width=100%}
