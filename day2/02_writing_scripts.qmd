...
:::
:::{.column width="60%"}
![](../images/new_r_script.png){width="100%"}
:::
::::
...
:::{.column width="40%" .smaller}
<br><br>
Script structure can be clear written out in the script.
:::
:::{.column width="60%"}
![](../images/structure.png){width="80%"}
:::
::::
...
![](../images/bad_script.png){width="70%"}
</div>
